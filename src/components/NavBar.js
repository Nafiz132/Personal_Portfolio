...
import portf from '../images/nrs1.jpg.png';
...
const NavBar = () => {
  ...
  return (
    <Navbar expand="lg" className={scrolled?"scrolled":""}>
      <Container>
        <Navbar.Brand href="#home"><img src={portf} alt='logo'/></Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <span className='navbar-text'>
            <div className='social-icon' >
                <a href="https://github.com/Nafiz132" target='blank'><img src={navIcon4} alt="Git Hub"/></a>
